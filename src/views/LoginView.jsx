  ...
  return (
    <>
      ...
      <div style={{
        ...
        background:"linear-gradient(160deg,#FFFBF5 0%,#F5F3FF 55%,#FFFBF5 100%)",
          ...
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",marginBottom:36}}>
            <div style={{position:"relative",marginBottom:16}}>
              <div style={{
                ...
                boxShadow:"0 18px 48px rgba(255,107,53,.4)",
              ...
              <div style={{position:"absolute",top:-6,right:-6,width:28,height:28,borderRadius:"50%",
            ...
            <h1 style={{fontSize:34,fontWeight:900,letterSpacing:"-.03em",color:"#1E1B4B",lineHeight:1}}>
              Room<span style={{color:"#FF6B35"}}>Khata</span>
            </h1>
            <p style={{fontSize:10,fontWeight:700,letterSpacing:".3em",color:"#A0AEC0",marginTop:6}}>
              RENT · TRACK · RELAX
            </p>
