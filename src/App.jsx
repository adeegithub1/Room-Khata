...
function Root() {
  ...
  // authUser exists but no role yet — new owner after signup
  // (AppContext will have set role before routing here normally,
  //  but if we land here the user is in onboarding flow)
