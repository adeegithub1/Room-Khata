            ...
            <div class="bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-3xl p-4 mb-4 shadow-lg">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button onclick="addNewRoom('${buildingId}')" class="h-8 px-2.5 bg-white/20 hover:bg-white/30 rounded-xl flex items-center gap-1 text-xs font-black transition-all active:scale-90" title="Add Room">
                            <i class="fa-solid fa-plus text-[10px]"></i> Room
                        </button>
                        ` : ''}
