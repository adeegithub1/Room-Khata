...
const TRANSLATIONS = {
  ...
  hi: {
    settings: 'सेटिंग्स', editProfile: 'प्रोफ़ाइल संपादित करें', preferences: 'प्राथमिकताएं',
    language: 'भाषा', darkMode: 'डार्क मोड', notifications: 'सूचनाएं',
    data: 'डेटा', backupData: 'बैकअप डेटा', logout: 'लॉगआउट',
    totalRevenue: 'कुल आय', pendingDues: 'बकाया राशि',
    yourBuildings: 'आपके भवन', addBuilding: 'भवन जोड़ें',
    quickActions: 'त्वरित क्रियाएं', remindAllPending: 'सभी बकाया किरायेदारों को याद दिलाएं',
    thisMonth: 'इस माह', urgent: 'जरूरी',
    allRooms: 'सभी कमरे', pending: 'बकाया', paid: 'भुगतान',
    home: 'होम', tenants: 'किरायेदार', payments: 'भुगतान',
    amountDue: 'इस माह कुल बकाया', payRent: 'किराया भरें', raiseComplaint: 'शिकायत दर्ज करें',
    tenantComplaints: 'किरायेदार शिकायतें', paymentRequests: 'भुगतान अनुरोध',
  }
};
...
// Override the existing openUpiApp to set pending_verification
const _origOpenUpiApp = window.openUpiApp;
window.openUpiApp = async function(appName) {
  ...
  // Set status to pending_verification so owner knows payment was initiated
  try {
    ...
    console.warn('Could not update payment status:', err);
  }

  // Now open the UPI app
  if (_origOpenUpiApp) {
    _origOpenUpiApp(appName);
  } else {
    const upiId = tenantRoomData.ownerUpiId || 'owner@upi';
    const upiUrls = {
      gpay: `tez://upi/pay?pa=${upiId}&pn=RentPayment&am=${balanceDue}&cu=INR`,
      phonepe: `phonepe://pay?pa=${upiId}&pn=RentPayment&am=${balanceDue}&cu=INR`,
      paytm: `paytmmp://pay?pa=${upiId}&pn=RentPayment&am=${balanceDue}&cu=INR`
    };
